...
public class FirstPersonCameraScene extends Scene implements ScreenController{
    ...
    public void onTransformDataChanged(Object source, final TransformData data) {
        ...
        app.enqueue(new Callable<Boolean>() {
            public Boolean call() throws Exception {
                ...
                camera.setRotation(revertQuaternion(data.getQuaternion()));
    ...
    protected void initCamera() {
        ...
        camera.setRotation(revertQuaternion(RotationModel.getInstance().getTransformData().getQuaternion()));
    ...
    private void rotate(float x, float y, float z){
     ...
     private Quaternion revert(Quaternion q){
         return new Quaternion(new float[] { 0f, (float)Math.PI, 0f }).mult(q);
     }
     
     private Quaternion revertQuaternion(Quaternion q){
